...
public class New_student {
  public void insertUpdateDeleteStudent( char operation, Integer id, 
          String fname, String lname, String sex, String bdate, String phone, String address) 
  {
       Connection con = MyConnection.getConnection();
        ...
        if(operation == 'D'){
            ...
            int YesNo =  JOptionPane.showConfirmDialog(null,"Score is also Deleted"," Deleted student", JOptionPane.OK_CANCEL_OPTION,0);
            if(YesNo == 0)
            {
